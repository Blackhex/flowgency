...
def build_setup_prompt(
    ...
    *,
    ...
    return (
        ...
        "Render every exact profile label with explicit `None proposed` for "
        "unsupported optional labels, and verify the profile count and label "
        "completeness before the team decision. When the group concept provides "
        "a clear theme, apply it to every display name and title. "
