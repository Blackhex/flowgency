...
def build_ticket_reporting_protocol(
    *,
    ...
    lines = [
        ...
        "existing completed work may already satisfy them. Submit required outputs and one",
        "assessment for each criterion the transition declares. Inputs and preconditions are",
        "not criteria and never get an assessment; submit an empty assessments list when the",
        "transition declares none. Only an accepted transition changes ticket state.",
