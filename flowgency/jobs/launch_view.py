...
from flowgency.blueprints.cache import CompiledArtifact
...
def create_launch_view(artifact: CompiledArtifact, destination: Path) -> Path:
    ...
    # Safety net: create writable zone dirs so callers that skip launch-memory
    # preparation still get a structurally complete launch view.
