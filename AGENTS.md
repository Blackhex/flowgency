...
- `flowgency.agent_library` contains reusable blueprint source: `AGENTS.md` and `.agents/skills/<name>/SKILL.md`.
- `flowgency.compilation_cache` contains disposable immutable integration projections.
