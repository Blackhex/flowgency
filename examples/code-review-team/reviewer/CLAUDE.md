...
- `observations/` within the Flowgency-owned team root — Issues found by other agents
- `semantic memory` — Coding conventions and known patterns
- The project's source code

## What You Write

- `observations/` within the Flowgency-owned team root — Code quality findings with specific file/line references
- `proposals/` within the Flowgency-owned team root — Refactoring proposals when patterns recur
