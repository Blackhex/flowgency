...
- `shared/observations/` — Related findings from other agents
- `shared/memory.md` — Known security decisions and accepted risks

## What You Write

- `shared/observations/` — Security findings with severity (critical/high/medium/low)
- `shared/proposals/` — Security hardening proposals
